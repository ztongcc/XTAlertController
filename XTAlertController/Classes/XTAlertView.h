...
typedef NS_ENUM(NSUInteger, XTAlertActionStyle) {
    XTAlertActionStyleDefault,
    XTAlertActionStyleCancel,
    XTAlertActionStyleDestructive,
};

@interface XTAlertAction : NSObject <NSCopying>

+ (instancetype)actionWithTitle:(NSString *)title style:(XTAlertActionStyle)style handler:(void (^)(XTAlertAction *action))handler;

@property (nonatomic, readonly) NSString *title;
@property (nonatomic, readonly) XTAlertActionStyle style;
